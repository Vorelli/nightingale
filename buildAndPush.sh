...
docker buildx build --cache-from type=local,src=/tmp/docker-cache --cache-to type=local,dest=/tmp/docker-cache,mode=max --push --platform linux/amd64 -t vorelli/nightingale:$TAG -t vorelli/nightingale:latest .
